  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.articleMain}>
        ...
        <p>
          You can view me yap about this hook here: <a style={link} href='https://www.youtube.com/watch?v=jXFiuJ6Z5kg'>useFetch Custom Hook</a>
        </p>
        <HL />
        ...
        <article>
          <h4>My implementation of useFetch hook makes use of a few interesting things:</h4>
          <ol>
          ...
          <CodeBlock code={a} />
          <p>useFetch is a hook which we should be able to call, with a URL, and get back either some data, or an error.</p>
